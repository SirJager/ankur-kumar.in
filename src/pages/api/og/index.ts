...
export const GET: APIRoute = async ({ url }) => {
	...
	const tagss = url.searchParams.get("tags");
	const tags = (tagss || "").split(",");
	const categories = url.searchParams.get("categories");
	const cats = (categories || "").split(",");
	const published = url.searchParams.get("date") || url.searchParams.get("published");
	...
	const isDark = url.searchParams.get("darkmode") === "true";
